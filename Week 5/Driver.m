...
folder = fullfile('C:\Users\Shane\Desktop\TEST'); %locating the folder of the desired image
fileDesired = 'MathFractal.mp4'; %giving the desired name of the file we want
